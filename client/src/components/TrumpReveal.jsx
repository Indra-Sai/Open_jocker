  ...
  return (
    <div className="fixed inset-0 bg-navy-950/90 backdrop-blur-md z-50 flex items-center justify-center pointer-events-none">
      <div className="text-center animate-trump-reveal">
        ...
        <div className={`text-[9rem] leading-none font-bold ${col}`} style={{ textShadow: '0 0 60px currentColor' }}>
          {suit}
        </div>
        <p className={`text-3xl font-display font-bold mt-2 ${col}`}>{getSuitLabel(suit)}</p>
